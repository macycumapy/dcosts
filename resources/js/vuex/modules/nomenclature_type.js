...
const actions = {
  ...
  addNomenclatureType: ({ dispatch }, payload) => dispatch('request/post', {
    url: 'nomenclature-types',
    params: payload,
  }).finally(() => {
    dispatch('getNomenclatureType');
  }),
  updateNomenclatureType: ({ dispatch }, payload) => dispatch('request/put', {
    url: `nomenclature-types/${payload.id}`,
    params: payload,
  }).finally(() => {
    dispatch('getNomenclatureType');
  }),
  deleteNomenclatureType: ({ dispatch }, id) => dispatch('request/del', {
